...
export function Sidebar() {
  ...
  return (
    <GlassPanel className="p-4">
      <div className="mb-5 flex items-center gap-3 rounded-2xl bg-gradient-to-br from-zinc-800/60 to-black/70 p-4">
            ...
            <NavLink
              ...
              className={({ isActive }) =>
                `group flex items-center justify-between rounded-2xl px-3 py-2 text-sm transition duration-200 hover:-translate-y-0.5 hover:bg-white/10 ${
                  isActive ? 'bg-white/10 text-white shadow-[inset_0_0_20px_rgba(255,255,255,0.08)]' : 'text-zinc-300'
                }`
              }
            >
