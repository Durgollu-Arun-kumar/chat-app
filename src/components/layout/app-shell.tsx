...
export function AppShell({ children }: PropsWithChildren) {
  return (
    <div className="min-h-screen bg-[#0d0d11] text-zinc-100">
      <div className="pointer-events-none fixed inset-0 bg-[radial-gradient(circle_at_20%_10%,rgba(110,110,120,0.16),transparent_35%),radial-gradient(circle_at_80%_85%,rgba(45,45,52,0.22),transparent_35%)]" />
