    ...
    <div className="fixed inset-0 z-50 grid place-items-center bg-black/50 backdrop-blur-sm">
      ...
      >
        ...
        <input
          ...
          className="mb-4 w-full rounded-2xl border border-white/10 bg-black/20 px-4 py-3 text-sm text-zinc-100 outline-none placeholder:text-zinc-500 focus:border-violet-300/40"
        />
        <button
          type="submit"
          className="w-full rounded-2xl border border-violet-300/20 bg-gradient-to-r from-violet-500/45 to-orange-300/35 px-4 py-3 text-sm font-medium text-white transition duration-200 hover:-translate-y-0.5"
        >
          Continue
        </button>
      </motion.form>
